...
public class Loginlnterceptor implements HandlerInterceptor {
    ...
    public Loginlnterceptor(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
    }

    /**
     * Controller中请求方法执行前,就会调用preHandle,
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        r.setCode("ERR401");
        r.setMessage("用户未登录不能访问");
        String json = objectMapper.writeValueAsString(r);//将Java对象序列化
